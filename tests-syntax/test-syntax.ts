...
const themeName = "Evergarden";
let themeVersion = 1.0;
var isDark = true;
...
const shortArrow = (x: number): number => x * 2;
...
const templateString = `Template string with ${themeName} interpolation`;
...
function restParams(...args: any[]): void {
    console.log(args);
}
